...
function showData()
{
var id=document.getElementById('cat_cmb').selectedIndex;
xmlhttp=new XMLHttpRequest();
xmlhttp.open("GET","ajaxpage.php?catId="+id,true);
xmlhttp.send();
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Advanced Table</div>
                        ...
                        <select id="cat_cmb" name="cat_cmb" onChange="showData()">
						...
						echo '<option id=$row["c_id"]>'.$row['c_name'].'</option>';
						}
				...
				<!--		<table data-toggle="table" data-url=""  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">-->
						   ...
						   echo ' <tr>';
						        ...
						        echo '<th data-field="name"  data-sortable="true">Item Name</th>';
                            ...
                            echo '<tbody>';
								...
								while($row=mysqli_fetch_assoc($query))
										...
										{
											echo '<tr>';
											 echo  "<td  data-checkbox='".true."'>".$row['stdName']."</td>";
										echo '</tr>';
										}
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body" id="catDiv">
